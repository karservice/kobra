# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-15 21:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liu_id', models.CharField(max_length=8, verbose_name='LiU ID')),
                ('liu_lin', models.UUIDField(verbose_name='LiU LIN')),
                ('mifare_id', models.BigIntegerField(blank=True, help_text='This field *must not* be used for anything else than caching. It is never guaranteed to be up-to-date and must not be disclosed publicly.', null=True, verbose_name='Mifare ID')),
